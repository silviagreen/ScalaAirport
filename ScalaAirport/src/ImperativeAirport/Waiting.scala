...
/**
 * Classe che si occupa di aspettare un aereo in ritardo 
 * e di assegnargli la pista non appena si libera.
 * Si usa in modo da non bloccare la circolazione degli aerei 
 * a causa di un ritardo
 * 
 * Ritardo = coda delle partenze (o arrivi) vuota
 * 
 * @constructor crea un thread che attende l'arrivo di un aereo in ritardo
 * @param queue	la coda su cui attendere
 * @param isLanding true se attende un atterraggio, false se attende un decollo
 */
